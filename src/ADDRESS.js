...
async function displayRazorpay(temp) {
  const {
    ...
    const result = await axios.post("http://localhost:5000/payment",temp);
        ...
        handler: async function (response) {
          history.push("/payment_success");
           ...
           // const result = await axios.post("http://localhost:5000/payment/success", data);
             axios.post('http://localhost:5000/address',temp).then((res) => {
...
await displayRazorpay(temp);}
  ...
  .post('http://localhost:5000/address',temp)
